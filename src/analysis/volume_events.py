...
#
# Порог задаётся переменной VOLUME_FLOOR_RUB и НЕ привязан к чьему-то счёту.
#
...
FLOOR_RUB = float(os.getenv("VOLUME_FLOOR_RUB", "50000"))
