...
class MarketDataServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMarketValues = channel.unary_unary(
                ...
                request_serializer=marketdata__pb2.GetMarketValuesRequest.SerializeToString,
                response_deserializer=marketdata__pb2.GetMarketValuesResponse.FromString,
                _registered_method=True)
...
def add_MarketDataServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMarketValues': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=marketdata__pb2.GetMarketValuesRequest.FromString,
                    response_serializer=marketdata__pb2.GetMarketValuesResponse.SerializeToString,
            ),
    }
...
class MarketDataService(object):
    ...
    def GetMarketValues(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/tinkoff.public.invest.api.contract.v1.MarketDataService/GetMarketValues',
            marketdata__pb2.GetMarketValuesRequest.SerializeToString,
            marketdata__pb2.GetMarketValuesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
